...
static void test_full_pipeline(void) {
    ...
    { char _pp[512]; tmp_path(_pp,sizeof(_pp),"cvcl_pipe.png");
    ASSERT_EQ(cvcl_io_write_png_native(&thr,_pp),CVCL_OK);
    ASSERT_EQ(cvcl_io_read_png_native(&rel,_pp,NULL),CVCL_OK);
    remove(_pp); }
